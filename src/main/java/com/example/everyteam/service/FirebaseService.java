...
import static com.example.everyteam.config.exception.ErrorResponseStatus.FILE_SAVE_ERROR;
...
public class FirebaseService {
    ...
    public String uploadFiles(String fileName, MultipartFile file) {
        ...
        String img_url = "https://firebasestorage.googleapis.com/v0/b/everyteam-6559d.appspot.com/o/"
                +fileName+"?alt=media";
        return img_url;
    }
